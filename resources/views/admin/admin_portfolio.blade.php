                ...
                <div>
                    ...
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Вторая карта</li>
                        </ol>
                    </nav>
                </div>
                <button class="btn btn-carousel ms-auto" data-bs-toggle="modal" data-bs-target="#addportfolio">Добавить Карту</button>
            </div>
            <!-- End Page Title -->
        </div>
                    ...
                    <div class="card info-card sales-card pb-0">
                       ...
                       <div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <li><a class="dropdown-item" href="/delete_CardPotfoliot/{{$item->id}}">Удалить</a></li>
                            </ul>
                            </div>
    
                            <div class="card-body">
                            <h2 class="carousel-name mt-2 text-truncate w-75">{{$item->title}}</h2> 
                            <div style="background-image: url(storage/CardPortfolio/{{$item->img}}); background-size: cover; height: 200px"></div>     
                            </div>
                    </section><!-- End Hero -->
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/exit_CardPotfolio/{{$item->id}}" method="POST" enctype="multipart/form-data">
                                    @csrf
...
<div class="modal fade" id="addportfolio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header d-flex border-0">
                <h3 class="modal-title ms-auto" id="addservice">Добавить </h3>
                <button type="button" class="btn-close fs-4" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="/add_CardPotfolio" method="POST" enctype="multipart/form-data">
                    @csrf
