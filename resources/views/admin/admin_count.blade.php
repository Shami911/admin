                 ...
                 @foreach ($count as $item)
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card sales-card pb-0">
                            ...
                            <h2 class="carousel-name mt-2 text-truncate w-75">{{$item->CountClients}}</h2> 
                             <h2 class="carousel-name mt-2 text-truncate w-75">{{$item->Projects}}</h2>    
                            <h2 class="carousel-name mt-2 text-truncate w-75">{{$item->CountProjects}}</h2> 
                             <h2 class="carousel-name mt-2 text-truncate w-75">{{$item->Support}}</h2>    
                            <h2 class="carousel-name mt-2 text-truncate w-75">{{$item->CountSupport}}</h2>
                            <h2 class="carousel-name mt-2 text-truncate w-75">{{$item->Workes}}</h2>    
                            <h2 class="carousel-name mt-2 text-truncate w-75">{{$item->CountWorkes}}</h2>   
